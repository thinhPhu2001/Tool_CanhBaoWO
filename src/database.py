    ...
    while retries < max_retries and not connected:
        try:
            with engine.connect() as connection:
                ...
                query_TKM = "select * from qlctkt.tkm_cdbr_open where `tỉnh/tp` = 'Hậu Giang' and `Dịch vụ` in ('SmartTV360 trả sau', 'FTTH', 'BoxTV360 trả sau', 'Camera', 'IPPhone', 'Multiscreen 2 chiều')"
                ...
                query_PAKH = "SELECT * FROM bccs.pakh_ton where `Nguồn tiếp nhận` = 'Hậu Giang'"
